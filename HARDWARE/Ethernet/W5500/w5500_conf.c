...
/*定义默认IP信息*/
uint8 local_ip[4]  ={192,168,31,123};											/*定义W5500默认IP地址*/
...
uint8 w55_ip[4]  ={0};											/*定义W5500默认IP地址*/

uint16 local_port=5000;	                       					/*定义本地端口*/

/*定义远端IP信息*/
uint8  remote_ip[4]={192,168,31,161};											/*远端IP地址*/
uint16 remote_port=8899;																/*远端端口号*/
...
//		
	...
	getSIPR (w55_ip);			
	printf(" W5500 IP地址   : %d.%d.%d.%d\r\n", w55_ip[0],w55_ip[1],w55_ip[2],w55_ip[3]);
	getSUBR(subnet);
